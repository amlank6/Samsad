...
if(isset($_GET["s_id"]))
{
	$_SESSION["sid"]	=	$_GET["s_id"];
}

if(isset($_SESION["sid"]) AND isset($_GET["s_id"]))
{
	if($_SESSION["sid"] != $_GET["s_id"])
	{
	session_destroy();
	$_SESSION["sid"]	=	$_GET["s_id"];
	}
...
{
$num	=	$_GET["page"];
$count_row1	=	$count_row	-	(12 * $_GET["page"]);
$show	=	$count_row - $count_row1;
} 
else
{
if($count_row > 12)
{
$count_row1	=	$count_row	-	12;
$show		=	$count_row - $count_row1;
}
else
{
...
?>
 Products of <?php echo $count_row; ?> Products</p>
...
$sid			=	$_SESSION["sid"];
$tableName		=	"product";
$query 			= 	"SELECT COUNT(*) as num FROM $tableName WHERE p_sub_category='".$_SESSION["sid"]."'AND p_status='0' AND p_inventory > 0 ORDER BY id DESC ";
$query1a 		= 	"SELECT * FROM $tableName WHERE p_sub_category='".$_SESSION["sid"]."'AND p_status='0' AND p_inventory > 0 ORDER BY id DESC ";
//$targetpage 	= 	"product-listing.php?s_id=".$sid."'&";
$targetpage		=	"product-listing.php";
$limit 			= 	"12"; 
