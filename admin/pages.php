...
<br />
<h2><img src="images/pages.png" alt="" title="" border="0" />&nbsp;Manage Pages</h2> 
...
<th scope="col" class="rounded">URL Key</th>
<th scope="col" class="rounded">Status</th>
<th scope="col" class="rounded">Date Created</th>
<th scope="col" class="rounded">Date Modified</th>
...
<td>add-new-product.php</td>
<td>Enable</td>
<td>Wednesday, 3 July, 2013</td>
<td>Wednesday, 3 July, 2013</td>
<td><a href="#">View</a></td>
</tr>
...
<tr>
<td colspan="8">
<a href="add-new-pages.php" class="bt_blue"><span class="bt_blue_lft"></span><strong>Add New Page</strong><span class="bt_blue_r"></span></a>
